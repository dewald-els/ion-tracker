...
export class SQLiteService {
  ...
  sqlitePlugin: any;
  native = false;
  readonly sqliteInitialized$: BehaviorSubject<boolean> = new BehaviorSubject(
    false
  );
...
/**
 * @author: https://github.com/capacitor-community/sqlite/blob/master/docs/Ionic-Angular-Usage.md#singleton-service-definition
 */
